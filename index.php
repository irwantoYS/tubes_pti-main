...
<body>
  <main style="background-color: #87cbb9">
    <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="card mb-2">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h6 class="card-title text-center pb-0 fs-3" style="color: black">
                      LOGIN
                    </h6>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post">
                    ...
                    <div class="col-12">
                      <button style="background-color: #04c99e" class="btn btn-primary w-100" type="submit">
                        Login
                      </button>
                    </div>
                  </form>
