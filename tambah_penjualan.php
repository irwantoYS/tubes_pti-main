    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" style="width: 40%;" id="harga_jual" name="harga_jual" readonly>
            </div>
            <div class="form-group">
                <label for="kuantitas">Jumlah Terjual:</label>
                <input type="number" class="form-control" style="width: 40%;" id="kuantitas" name="kuantitas">
            </div>
            <div class="form-group">
                <label for="tgl">Tanggal:</label>
                <input type="date" class="form-control" style="width: 40%;" id="tgl" name="tgl">
            </div>
